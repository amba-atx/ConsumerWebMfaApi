...
import io.consumerweb.mfa.client.auth.ApiKeyAuth;
import io.consumerweb.mfa.client.auth.Authentication;
import io.consumerweb.mfa.client.auth.HttpBasicAuth;
import io.consumerweb.mfa.client.auth.OAuth;
...
public class ApiClient
{
    ...
    public ApiClient() {
        this.basePath = "http://dummy.url.com:3048";
    ...
    public Call buildCall(final String path, final String method, final List<Pair> queryParams, final Object body, final Map<String, String> headerParams, final Map<String, Object> formParams, final String[] authNames, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        final Request request = this.buildRequest(path, method, queryParams, body, headerParams, formParams, authNames, progressRequestListener);
        return this.httpClient.newCall(request);
    }
    
    public Request buildRequest(final String path, final String method, final List<Pair> queryParams, final Object body, final Map<String, String> headerParams, final Map<String, Object> formParams, final String[] authNames, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private void applySslSettings() {
        try {
            ...
            if (this.keyManagers != null || trustManagers != null) {
                final SSLContext sslContext2 = SSLContext.getInstance("TLSv1.2");
                sslContext2.init(this.keyManagers, trustManagers, new SecureRandom());
